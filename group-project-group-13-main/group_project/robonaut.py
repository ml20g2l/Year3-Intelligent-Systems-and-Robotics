...
class RoboNaut(Node):
    def __init__(self):
        ...
        self.windows_ss_dir = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13'
        ...
        #empty folders
        save_directory = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13'
        clear_directory(save_directory)           
            
        folder_path = '/uolstore/home/users/sc21ar/ros2_ws/src'
        delete_planet_images(folder_path)

        folder_path = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/image_detection/extra_images'
            ...
            for contour in contours:
                ...
                if len(approx) == 4:
                    ...
                    if has_white_border and black_ratio > 0.5:
                        ...
                        filename = f'/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13/window{self.window_screenshot_counter}.png'
    ...
    def attempt_capture(self):
        ...
        if self.robot_close:
            ...
            if self.contour >= 0:
                filename = f'/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13/window{self.contour}.png'
    ...
    def detect_image_rename(self):
        ...
        if self.flag_window_processing0 == 1:
            ...
            model_path = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/data_training/model.pth'
            device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
            model = load_model(model_path, num_classes=4)
            model.to(device)
            #add the actual ss windows folder location here
            image_directory = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13'
            ...
            for image_path in images:
                ...
                new_image_directory = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13'
    ...
    def good_stitching(self):
        ...
        if self.flag_window_processing1 == 1:
            ...
            folder_path = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13'
            ...
            # Load the image
            image_path = '/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13/panorama.png'
            #image_path = '/uolstore/home/users/sc21ar/ros2_ws/src/final_panorama (1).jpg'
    ...
    def planet_measurements(self):
        ...
        if self.flag_window_processing2 == 1:
            ...
            if img is None:
                self.get_logger().info("Failed to load image.")
                return
            save_directory = '/uolstore/home/users/sc21ar/ros2_ws/src'
            image_height_pixels, image_width_pixels, _ = img.shape
            ...
            with open("/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13/measurements.txt", "w") as file:
                file.write("")
            ...
            if planet_details:
                ...
                for detail in planet_details:
                    filename = f"planet_{len(planet_positions)+1}.png"
                    cropped_image = locate_and_crop(filename)
                    cropped_image_path = "/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/image_detection/extra_images/cropped_planet.jpg"
                    cropped_image.save(cropped_image_path)  # Save the cropped image for prediction
                ...
                for index, pos in enumerate(planet_positions):
                    ...
                    with open("/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/group13/measurements.txt", "a") as file:
                ...
                cv2.imwrite('/uolstore/home/users/sc21ar/ros2_ws/src/group-project-group-13/image_detection/extra_images/detected_planets.png', img)
                #self.flag_window_processing2 = 0
                folder_path = '/uolstore/home/users/sc21ar/ros2_ws/src'
                #delete_planet_images(folder_path)
